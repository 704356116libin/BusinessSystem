...
public class MainFrame extends JFrame{
	...
	private void addMenu() {
		...
		menu1_item1=new JMenuItem("查看供应商 (A)");
	...
	private void addToolBar() {
		...
		tbut2.setIcon(new ImageIcon(this.getClass().getResource("/icon/gh.png")));
		toolBar.add(tbut2);
		
		tbut3=new JButton("退货单   ");
		tbut3.setIcon(new ImageIcon(this.getClass().getResource("/icon/gh.png")));
		toolBar.add(tbut3);
		
		tbut4=new JButton("销售单  ");
		tbut4.setIcon(new ImageIcon(this.getClass().getResource("/icon/gh.png")));
		toolBar.add(tbut4);
		
		tbut5=new JButton("采购单   ");
		tbut5.setIcon(new ImageIcon(this.getClass().getResource("/icon/gh.png")));
		toolBar.add(tbut5);
		
		tbut6=new JButton("人员调动 ");
		tbut6.setIcon(new ImageIcon(this.getClass().getResource("/icon/gh.png")));
		toolBar.add(tbut6);
		
		tbut7=new JButton("部门管理");
		tbut7.setIcon(new ImageIcon(this.getClass().getResource("/icon/gh.png")));
		toolBar.add(tbut7);
		
		tbut8=new JButton("客户一览 ");
		tbut8.setIcon(new ImageIcon(this.getClass().getResource("/icon/gh.png")));
		toolBar.add(tbut8);
		panel.add(toolBar);
