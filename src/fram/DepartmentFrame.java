...
public class DepartmentFrame extends JInternalFrame{
	...
	private static final String columns[]={"部门编号","部门名称"};
	...
	String id;
	String name;
	private DepartmentManager departmentManager;//用来查询数据
	private int row;
	 ...
	 */
	private void init() {
		departmentManager=new DepartmentManager();//首先实例化数据管理对象
		...
		field_id=new JTextField();id_label=new JLabel("部门编号:");
		field_name=new JTextField();name_label=new JLabel("部门名称:");
